  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Portfolio of Cevher Dogan, Cloud Platform Engineer and Automation Strategist." />
        <meta property="og:title" content="Cevher Dogan | Portfolio" />
        <meta property="og:description" content="Automation, cloud infrastructure, and DevSecOps expertise." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://cevherdogan-com.vercel.app" />
        <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@400;600&display=swap" rel="stylesheet" />
      </Head>

      <main className="min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-black dark:to-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-500 font-[Raleway]">
        <div className="absolute top-4 right-4">
          <button onClick={() => setDarkMode(!darkMode)} className="text-sm bg-gray-200 dark:bg-gray-800 px-3 py-1 rounded">
        ...
        <section className="max-w-4xl mx-auto px-4 py-16">
          ...
          <ul className="space-y-4">
            <li>
              <strong>ClaimGuard</strong> – An automation suite for ethical use cases in state benefit systems. <a href="https://github.com/cevherdogan/claimguard" className="underline" target="_blank">View Repo</a>
            </li>
            <li>
              <strong>Health Tourism AI</strong> – Simplifies the patient journey with AI-led approval workflows. <a href="https://github.com/cevherdogan/health-tourism-ai" className="underline" target="_blank">GitHub</a>
            </li>
          </ul>
        </section>
...
Cevher Dogan
Cloud Platform Engineer | Automation Strategist
📧 cevherd@gmail.com
🌐 Portfolio | LinkedIn | GitHub | Calendly
            </pre>
          </div>
        </section>
